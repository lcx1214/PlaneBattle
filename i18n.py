...
STRINGS = {
    ...
    "relay_addr_hint": {"zh": "免费公共中转：broker.emqx.io:1883（也可填其它 MQTT 服务器）",
                        "en": "Free public relay: broker.emqx.io:1883 (or any MQTT broker)",
                        "ja": "無料公共中継：broker.emqx.io:1883（他の MQTT サーバーも可）"},
